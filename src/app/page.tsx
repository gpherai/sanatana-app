            ...
            <div className="grid gap-6">
              {events?.map((event, index) => {
                ...
                return (
                  <div
                    key={event.id}
                    className="group bg-card border border-border/50 rounded-2xl p-6 shadow-soft hover:shadow-elegant transition-all duration-300 cursor-pointer animate-fade-in"
